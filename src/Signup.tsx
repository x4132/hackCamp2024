    ...
    return (
        <Flex mih="100vh" pos="fixed" w="100vw" top="0" style={{ zIndex: 100 }} bg="white" gap="xl" direction="column" p="20px">
            ...
            <Flex direction="column" align="center" gap="md">
                <Button variant="filled" size="xl" color="#f1f1f1" autoContrast leftSection={<Image src={IconEmail} w={22} h={22} />} w={350} justify="center" onClick={login}>Sign up with email</Button>

                <Button variant="filled" size="xl" color="#f1f1f1" autoContrast leftSection={<Image src={IconGoogle} w={20} h={20} />} w={350} justify="center" onClick={login}>Sign up with Google</Button>

                <Button variant="filled" size="xl" color="#f1f1f1" autoContrast leftSection={<Image src={IconApple} w={20} h={20} />} w={350} justify="center" onClick={login} >Sign up with Apple</Button>
            </Flex>
